...
\end{verbatim}
  ...
  greatly improved. Figure~3\ref{fig:sdg} shows a difference in output between
...
between the CDK modules are depicted in Figure~4\ref{fig:deps}.
...
\subsection*{Figure 2 - Integrated example showing the rendering and SMILES
...
\includegraphics[width=\textwidth]{sdg.png}
  ...
  \subsection*{Figure 4 - Dependencies between CDK modules.}\label{fig:deps}
