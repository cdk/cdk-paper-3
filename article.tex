...
\section*{Tables}
  \subsection*{Table 1 - The molecular fingerprints in CDK}
    ...
    \par
    \mbox{
    \begin{tabular}{lcclrc}
    \toprule
                             & Bit version  & Count version & CDK version & Default Size & References \\
  EStateFingerprinter        & $\checkmark$ &               & 1.2.0       & $79$         & \cite{Hall1995}\\
  ExtendedFingerprinter      & $\checkmark$ &               & 1.0         &              & \\
  Fingerprinter              & $\checkmark$ &               & 1.0         &              & \\
  GraphOnlyFingerprinter     & $\checkmark$ &               & 1.0         &              & \\
  HybridizationFingerprinter & $\checkmark$ &               & 1.4.0       &              & \\
  KlekotaRothFingerprinter   & $\checkmark$ &               & 1.4.6       & $4\,860$     & \cite{Klekota2008}\\
  LingoFingerprinter         & $\checkmark$ &               & 1.6.0 ?     &              & \\
  MACCSFingerprinter         & $\checkmark$ &               & 1.2.0       &              & \\
  PubchemFingerprinter       & $\checkmark$ &               & 1.4.0       &              & \\
  ShortestPathFingerprinter  & $\checkmark$ &               & 1.6.0 ?     &              & \\
  SignatureFingerprinter     & $\checkmark$ & $\checkmark$  & 1.6.0 ?     & $2^{32}$     & [pending] \\
  SubstructureFingerprinter  & $\checkmark$ &               & 1.0         &              & \\
  CirkularFingerprinter      & $\checkmark$ & ?             & ?           & ?            & [pending?] \\
  \bottomrule
    \end{tabular}}
