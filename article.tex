...
in some cheminformatics domains, such as fingerprinting~\cite{Clark2014,Cannon}, in other parts
...
\section*{Figures}
  ...
  \label{fig:deps}
      ...
      the cdk-core depends on the cdk-interfaces module.
