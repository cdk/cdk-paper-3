 ...
 *added extended valencies, added implementation of
   ...
   * removed above rules for the purpose of speed evaluation (Tomas Pluskal) 
...
--------------------------------------------------------------------
 ...
 Revision:  2001-04-18, GPL'd, first public release (JHa)
            ...
            2016-08-04, removed all formula checks for the purpose of speed evaluation (Tomas Pluskal)
...
"-t tol  Set tolerance to 'tol' amu (default 0.005).\n"
"-m mz   Set mass to 'mz'.\n"
...
tol = 0.005;			/* default tolerance in amu */
...
* Input: 	   measured mass (in amu), tolerance (in amu)	    	*
...
while (el[2].cnt++ < el[2].max) /*"H"*/{ 
	...
	//************************************************************************************************************/	
// printf("lo %f hi %f mass %f\n", limit_lo, limit_hi, mass);
