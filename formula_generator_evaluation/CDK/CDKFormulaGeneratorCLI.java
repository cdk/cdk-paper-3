...
public class CDKFormulaGeneratorCLI {
    ...
    public static void main(String args[]) {
        ...
        if (args.length != 3) {
            System.err
                    .println("Use 3 arguments: <mass> <tolerance> <elements>");
            System.err.println("For example:");
            System.err.println("      mass: 500.0");
        ...
        try {
            ...
            while (m.find()) {
                ...
                IIsotope i;
		if (element.equals("D")) i = ifac.getIsotope("H", 2);
			else i = ifac.getMajorIsotope(element);
                mfRange.addIsotope(i, min, max);
            }

            IChemObjectBuilder builder = SilentChemObjectBuilder.getInstance();
            MolecularFormulaGenerator gen = new MolecularFormulaGenerator (
                    builder, mass - tolerance, mass + tolerance, mfRange);
